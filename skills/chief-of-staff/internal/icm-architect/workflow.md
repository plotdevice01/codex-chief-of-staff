...
2. **A small, stable entry file.** `AGENTS.md` answers "where am I" and "where does everything live." It also says where to go for task X, and nothing else. Target under 60 lines.
...
**4. Write the contracts.** Write `AGENTS.md`, root `CONTEXT.md`, one `CONTEXT.md` per stage or hub, and `setup/questionnaire.md` when the factory needs user configuration. Write exact input paths, split into working and reference material.
...
- **Catalog** - identity and routing (becomes or feeds `AGENTS.md` or index files)
...
- [assets/templates/](assets/templates/) - copyable starters: `AGENTS.md`, workspace `CONTEXT.md`, `stage-CONTEXT.md`, `node.md`, `schema.md`, and `questionnaire.md`.
