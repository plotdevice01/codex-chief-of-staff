...
4. **Verify inputs and authority.** Check required facts, source provenance,
   ...
   first irreversible or external action.
...
or external target. Require explicit authorization for publication, sending,
media buying, permissions, destructive work, and external record writes.
