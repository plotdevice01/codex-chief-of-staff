...
```powershell
(Get-FileHash .\codex-chief-of-staff-v0.4.3.zip -Algorithm SHA256).Hash
```

macOS or Linux:

```bash
sha256sum ./codex-chief-of-staff-v0.4.3.zip
```

Compare the result with `codex-chief-of-staff-v0.4.3.zip.sha256`.
