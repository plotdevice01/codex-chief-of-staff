...
```powershell
(Get-FileHash .\Codex-Chief-of-Staff-v0.4.0.zip -Algorithm SHA256).Hash
```

macOS or Linux:

```bash
sha256sum ./Codex-Chief-of-Staff-v0.4.0.zip
```

Compare the result with `Codex-Chief-of-Staff-v0.4.0.zip.sha256`.
